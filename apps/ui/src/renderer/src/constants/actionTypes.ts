...
export enum WineActionType {
  ...
  SET_SELECTED_TAG = 'WINE:SET_SELECTED_TAG',
  SET_CHECKOUT_OUTPUT = 'WINE:SET_CHECKOUT_OUTPUT',
  SET_SELECTED_ARCH = 'WINE:SET_SELECTED_ARCH',
  SET_VERIFY_BEFORE_BUILD = 'WINE:SET_VERIFY_BEFORE_BUILD',
  SET_BUILD_OUTPUT = 'WINE:SET_BUILD_OUTPUT',
  SET_ARCHS = 'WINE:SET_ARCHS',
